...
def get_daily_report(date_string: str):
    ...
    total_discount_amount, items, order_total_avg, discount_rate_avg, commission_sum, commission_avg, promotions = get_order_data(order_queryset, vendor_queryset, promotion_queryset)
    report = {
...
def get_order_data(order_queryset: models.QuerySet, vendor_queryset: models.QuerySet, promotion_queryset):
    ...
    return total_discount_amount, items, order_total_avg, discount_rate_avg, commission_sum, commission_avg, promotions_totals
